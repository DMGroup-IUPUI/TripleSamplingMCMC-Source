...
public:
	...
	double getNodeWeight(unsigned int node, struct neighbor* tempNeighbors); 
	double getTripleWeight(graphlet* gl, struct neighbor* tempNeighbors);
	unsigned int totalNeighbors(struct neighbor* tempNeighbors);
	unsigned int totalDegree(graphlet* gl);
