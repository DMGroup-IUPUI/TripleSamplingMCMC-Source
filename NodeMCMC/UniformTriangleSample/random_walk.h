...
//node based MCMC
	double sampleCoEffNodeMCMC(long sampleCount,long walkLength,double exact)//returns row
	{
		long tri=0,path=0,currentSC=0;
		long currentWL=0;
	...
	void sampleTriangleNodeMCMC(long sampleCount,int walkLength)//returns row
	{
		long tri=0,currentSC=0;
		long currentWL=0;
